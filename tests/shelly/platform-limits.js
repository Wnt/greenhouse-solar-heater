...
const CAPS = {
  ...
  RUNTIME_PROXY_PEAK: 48000,      // re-calibrated 2026-05-03 after adding the per-tick `held` diagnostic (heldEntry/pruneHeld/attachHeld helpers + held-accumulator assignments at every gate point; measured 47199 + ~800 B margin). Prior: 46000 (measured 45419, set 2026-05-01 after adding the greenhouse_fan_cooling overlay). Earlier: 44700 (measured 44126, set 2026-04-23 after adding solarStallBypassDelta + mean-tank stall metric); 43800 (measured 43256, set 2026-04-20 after adding __test_setTemps / __test_controlTick hooks for scheduler-stack-fuzz automated-freeze coverage). Hooks are stripped at runtime by the __TEST_HARNESS guard — this only affects the in-test measurement.
