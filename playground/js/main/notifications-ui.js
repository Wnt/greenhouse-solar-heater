...
export function wireNotificationUI() {
  ...
  const checkboxes = document.querySelectorAll('[id^="notif-cat-"]');
  ...
  const testButtons = document.querySelectorAll('[data-test-category]');
  testButtons.forEach(function (btn) {
    btn.addEventListener('click', function () {
      ...
      const category = btn.dataset.testCategory;
      btn.disabled = true;
