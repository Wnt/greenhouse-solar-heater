...
const TUNING_FIELDS = [
  { key: 'geT', label: 'Greenhouse heat enter',     defaultValue: 10, min: 0,  max: 25,  step: 0.5, group: 'Greenhouse heating', help: 'Tank-fed heating starts when greenhouse drops below this.' },
  { key: 'gxT', label: 'Greenhouse heat exit',      defaultValue: 12, min: 1,  max: 30,  step: 0.5, group: 'Greenhouse heating', help: 'Tank-fed heating stops once the greenhouse exceeds this.' },
  { key: 'ehE', label: 'Emergency heater enter',    defaultValue: 9,  min: 0,  max: 20,  step: 0.5, group: 'Emergency heater',   help: 'Electric space heater fires when greenhouse drops below this.' },
  { key: 'ehX', label: 'Emergency heater exit',     defaultValue: 12, min: 1,  max: 25,  step: 0.5, group: 'Emergency heater',   help: 'Electric space heater stops once the greenhouse exceeds this.' },
