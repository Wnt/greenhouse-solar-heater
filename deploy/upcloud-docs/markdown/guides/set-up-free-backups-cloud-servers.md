...
![Creating a New Cloud Server](img/creating-new-cloud-server.png)

1. **Log in to your UpCloud Control Panel:** Navigate to the [UpCloud Control Panel](https://hub.upcloud.com/) and log in with your credentials.
...
![](img/enable-simple-backups.png)

### Updating an Already Running Cloud Server

1. **Log in to your UpCloud Control Panel:** Access your account on the [UpCloud Control Panel.](https://hub.upcloud.com/)
