# GPU Servers availability

### Available locations

GPU Servers are currently available with NVIDIA L4 and L40S GPUs from fi-hel2 (Helsinki, Finland).

| Location | NVIDIA L4 | NVIDIA L40S | NVIDIA H100 | NVIDIA B200 |
| --- | --- | --- | --- | --- |
